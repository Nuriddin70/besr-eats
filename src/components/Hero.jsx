  ...
  return (
    <div className="max-w-[1640px] mx-auto p-4">
      <div className="max-h-[500px] relative">
        {/* Overlay */}
        <div className="absolute w-full h-full text-gray-1 00 max-h-[500px] bg-black/40 flex flex-col justify-center"> 
        ...
        <img className="w-full m-h-[500px]" src="https://images.pexels.com/photos/1639562/pexels-photo-1639562.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Food" />
      </div>
    </div>
  )
}
